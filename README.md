...
This book is part of a progressive learning path for infrastructure professionals:
...
Author of [*Azure Governance Made Simple*](https://book.azgovernance.com/), [*Linux Hackathon*](https://linuxhackathon.com/), [*K8s Hackathon*](https://k8shackathon.com/), [*From Server to Cluster*](https://fromservertocluster.com/) and [*AKS Learning*](https://aks-learning.github.io/)
